...
# Skipped: the shared cocotbext-umi UmiMemoryDevice model does not service
# UMI_REQ_ATOMIC (only WRITE/POSTED/READ), so atomic responses never return.
# Re-enable once the memory model gains atomic support. See follow-up issue.
