...
async def test_posted_write(dut: SimHandleBase):
    """
    Test posted writes (no UMI response expected):
    ...
    # Verify APB memory contents directly
    ...
    # Note: If any unexpected responses arrive, the scoreboard will 
    # raise error
