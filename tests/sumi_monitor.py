...
from sumi import SumiCmd, SumiTransaction
        ...
        while True:
            ...
            if valid_handshake():
                ...
                self._recv(SumiTransaction(
                    cmd=sumi_cmd,
                    da=int(self.bus.dstaddr.value) if self.bus.dstaddr.value.is_resolvable else None,
                    sa=int(self.bus.srcaddr.value) if self.bus.srcaddr.value.is_resolvable else None,
